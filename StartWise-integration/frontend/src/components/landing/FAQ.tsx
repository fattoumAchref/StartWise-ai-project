...
const faqData = [
  {
    question: "How does Startwise accelerate product development?",
    answer: "Startwise uses advanced machine learning algorithms to analyze market trends, validate concepts, and provide data-driven insights. Our AI agents guide you through a structured 10-stage development process, automating research, competitor analysis, and strategic planning to reduce development time by up to 40%."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, Startwise is designed to scale from individual entrepreneurs to large enterprises. Our flexible architecture adapts to your team size, project complexity, and industry requirements. Whether you're launching a startup or developing new products within an established company, our platform grows with your needs."
  },
  {
    question: "What industries does Startwise support?",
    answer: "Startwise supports a wide range of industries including technology, healthcare, consumer goods, fintech, e-commerce, and more. Our AI models are trained on diverse market data and can adapt to specific industry requirements, regulations, and market dynamics."
  },
  {
  ...
  {
    question: "Can I integrate Startwise with existing tools?",
    answer: "Yes, Startwise offers robust API integration capabilities and supports popular project management, CRM, and business intelligence tools. We provide seamless integration with platforms like Slack, Trello, Salesforce, and more to fit into your existing workflow."
  },
  {
  ...
  },
  {
    ...
    answer: "Startwise employs enterprise-grade security measures including end-to-end encryption, secure data storage, and compliance with GDPR, CCPA, and other privacy regulations. Your business ideas and data are protected with bank-level security protocols."
  }
];
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Find answers to common questions about Startwise and how it can transform your product development process.
          </p>
        </motion.div>
