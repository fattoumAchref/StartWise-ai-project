...
from finagents.models.data_models import FinancialContext, KPIResult, DataQuality
...
def calculate_kpis(context: FinancialContext) -> KPIResult:
    ...
    if cash is None:
        ...
        # Startup cash-flow positive — le concept de runway ne s'applique pas
        runway_months  = None
        runway_weeks   = None
        cash_out_alert = "RENTABLE"
    else:
