...
def _simulate_scenario(
    ...
    runway_final = runway if runway < horizon_mois else round(
        cash / max(burn - revenue, 0.01), 1
    )
...
def _build_recommandation(
    ...
    # Situation saine
    return (
        f"Situation saine : runway réaliste de {realiste.runway_months} mois. "
